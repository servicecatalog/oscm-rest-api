...
public class UserRepresentationTest {
        ...
        public void shouldUpdateVOUserDetails() {
                ...
                representation.setOrganizationRoles(
                        Sets.newHashSet(OrganizationRoleType.SUPPLIER));
                ...
                representation.setUserRoles(
                        Sets.newHashSet(UserRoleType.SERVICE_MANAGER));
                ...
                assertThat(result).extracting(VOUserDetails::getAddress)
                        .isEqualTo(representation.getAddress());
                assertThat(result).extracting(VOUserDetails::getEMail)
                ...
                assertThat(result).extracting(VOUserDetails::getLocale)
                        .isEqualTo(representation.getLocale());
                assertThat(result)
                ...
                assertThat(result).extracting(VOUserDetails::getPhone)
                        .isEqualTo(representation.getPhone());
                assertThat(result)
                ...
                assertThat(result).extracting(VOUserDetails::getStatus)
                        .isEqualTo(representation.getStatus());
                assertThat(result)
        ...
        public void shouldConvertVOToRepresentation() {
                ...
                userDetails.setOrganizationRoles(
                        Sets.newHashSet(OrganizationRoleType.SUPPLIER));
