...
public class OnBehalfUserRepresentationTest {
        ...
        public void shouldCreateOnBehalfUserRepresentation_givenVOUserDetails() {
                ...
                assertThat(result).extracting(r -> r.getOrganizationId())
                        .isEqualTo(input.getOrganizationId());
                assertThat(result).extracting(r -> r.getETag())
                        .isEqualTo((long) input.getVersion());
                assertThat(result).extracting(r -> r.getUserId())
        ...
        public void shouldSetPassword() {
                ...
                assertThat(result).extracting(r -> r.getPassword())
                        .isEqualTo(passwordToSet);
        }
}
