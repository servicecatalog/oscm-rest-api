...
public class OrganizationResourceTest {
        ...
        public void shouldCreateOrganization() {
                when(backend.postOrganization())
                        .thenReturn(
                                ((accountRepresentation, accountParameters) -> "newId"));

                try {
                        result = resource.createOrganization(uriInfo,
                                accountRepresentation, parameters);
                } catch (Exception e) {
                        fail(e);
                }
        ...
        public void shouldGetOrganization() {
                when(backend.getOrganization())
                        .thenReturn((accountParameters -> orgRepresentation));
