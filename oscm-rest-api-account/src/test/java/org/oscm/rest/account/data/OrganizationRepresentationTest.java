...
public class OrganizationRepresentationTest {
        ...
        public void shouldUpdateVOOrganization() {
                ...
                assertThat(voOrganization).extracting(VOOrganization::getEmail)
                        .isEqualTo(orgRepresentation.getEmail());
                assertThat(voOrganization).extracting(VOOrganization::getKey)
                        .isEqualTo(orgRepresentation.getId());
                assertThat(voOrganization).extracting(VOOrganization::getLocale)
                        .isEqualTo(orgRepresentation.getLocale());
                assertThat(voOrganization).extracting(VOOrganization::getName)
                ...
                assertThat(voOrganization).extracting(VOOrganization::getPhone)
                ...
                assertThat(voOrganization).extracting(VOOrganization::getUrl)
        ...
        public void shouldConvertToOrganizationRepresentation() {
                ...
                assertThat(orgRepresentation).extracting(
                        OrganizationRepresentation::getDomicileCountry)
                ...
                assertThat(orgRepresentation).extracting(
                        OrganizationRepresentation::getOrganizationId)
