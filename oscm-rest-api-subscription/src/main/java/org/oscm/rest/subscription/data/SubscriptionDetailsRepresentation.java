...
public class SubscriptionDetailsRepresentation extends Representation {
        ...
        public void convert() {
                ...
                setOperations(OperationRepresentation
                        .convert(vo.getTechnicalServiceOperations()));
                if (vo.getPaymentInfo() != null) {
                        setPaymentInfo(new PaymentInfoRepresentation(
                                vo.getPaymentInfo()));
                ...
                setService(
                        new ServiceRepresentation(vo.getSubscribedService()));
                getService().convert();
                ...
                setUsageLicenses(UsageLicenseRepresentation
                        .convert(vo.getUsageLicenses()));
        }
        ...
        public void setBillingContact(
                BillingContactRepresentation billingContact) {
        ...
        public void setUsageLicenses(
                List<UsageLicenseRepresentation> usageLicenses) {
