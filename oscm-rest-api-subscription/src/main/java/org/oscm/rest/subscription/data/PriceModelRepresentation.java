...
public class PriceModelRepresentation extends Representation {
        ...
        public void update() {
                ...
                vo.setSteppedPrices(
                        SteppedPriceRepresentation.update(getSteppedPrices()));
                vo.setType(getType());
        ...
        @Override
        public void convert() {
                setConsideredEvents(PricedEventRepresentation
                        .convert(vo.getConsideredEvents()));
                ...
                setRoleSpecificUserPrices(PricedRoleRepresentation
                        .convert(vo.getRoleSpecificUserPrices()));
                setSelectedParameters(PricedParameterRepresentation
                        .convert(vo.getSelectedParameters()));
                setSteppedPrices(SteppedPriceRepresentation
                        .convert(vo.getSteppedPrices()));
                setType(vo.getType());
        }
        ...
        public void setPricePerUserAssignment(
                BigDecimal pricePerUserAssignment) {
