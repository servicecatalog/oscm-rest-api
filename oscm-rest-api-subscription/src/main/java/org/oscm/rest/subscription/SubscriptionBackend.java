...
public class SubscriptionBackend {
        ...
        getCollection() {
                return new RestBackend.GetCollection<SubscriptionRepresentation, SubscriptionParameters>() {
                        ...
                        @Override
                        public RepresentationCollection<SubscriptionRepresentation> getCollection(
                                ...
                                if (params.getUserId() != null) {
                                        ...
                                        subs = ssi.getSubscriptionsForUser(u,
        ...
        public RestBackend.Delete<SubscriptionParameters> delete() {
                return new RestBackend.Delete<SubscriptionParameters>() {
                        ...
                        public boolean delete(SubscriptionParameters params)
                                throws Exception {
                                return ss
                                        .unsubscribeFromService(params.getId());
                        }
                };
        }
        ...
        public RestBackend.Get<SubscriptionDetailsRepresentation, SubscriptionParameters> get() {
                return new RestBackend.Get<SubscriptionDetailsRepresentation, SubscriptionParameters>() {
                        ...
                        @Override
                        public SubscriptionDetailsRepresentation get(
                                SubscriptionParameters params)
                                throws Exception {
                                VOSubscriptionDetails sub = ss
                                        .getSubscriptionDetails(
                                                params.getId().longValue());
                                return new SubscriptionDetailsRepresentation(
                                        sub);
                        }
                };
        }
