...
public class PricedParameterRepresentation extends Representation {
        ...
        public void update() {
                ...
                vo.setPricedOptions(
                        PricedOptionRepresentation.update(getPricedOptions()));
        ...
        public void convert() {
                ...
                setPricedOptions(PricedOptionRepresentation
                        .convert(vo.getPricedOptions()));
        ...
        public void setParameterDef(
                ParameterDefinitionRepresentation parameterDef) {
