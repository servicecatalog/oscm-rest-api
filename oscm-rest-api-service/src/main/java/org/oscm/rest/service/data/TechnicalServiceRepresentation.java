...
public class TechnicalServiceRepresentation extends Representation {
        ...
        private List<EventDefinitionRepresentation> eventDefinitions =
                new ArrayList<EventDefinitionRepresentation>();
        ...
        private List<ParameterDefinitionRepresentation> parameterDefinitions =
                new ArrayList<ParameterDefinitionRepresentation>();
        private List<RoleDefinitionRepresentation> roleDefinitions =
                new ArrayList<RoleDefinitionRepresentation>();
        ...
        public void convert() {
                ...
                setTechnicalServiceDescription(
                        vo.getTechnicalServiceDescription());
        ...
        private List<OperationRepresentation> convertOperations() {
                ...
                for (VOTechnicalServiceOperation o : vo
        ...
        private List<ParameterDefinitionRepresentation> convertParameters() {
                List<ParameterDefinitionRepresentation> result =
                        new ArrayList<ParameterDefinitionRepresentation>();
