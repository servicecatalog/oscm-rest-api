...
class PricedParameterRepresentationTest {
    ...
    public void shouldUpdateVOPricedParameter() {
        ...
        assertThat(((VOPricedOption) result.getPricedOptions().toArray()[0]).getParameterOptionKey())
                .isEqualTo(
                        ((PricedOptionRepresentation) representation.getPricedOptions().toArray()[0]).getParameterOptionKey());
        assertThat(result)
        ...
        assertThat(result)
                ...
                .isEqualTo(representation.getPricePerUser());
        assertThat(
                ((VOPricedRole) result.getRoleSpecificUserPrices().toArray()[0]).getPricePerUser())
                .isEqualTo(
                        ((PricedRoleRepresentation) representation.getRoleSpecificUserPrices().toArray()[0]).getPricePerUser());
        assertThat(
                ((VOSteppedPrice) result.getSteppedPrices().toArray()[0]).getLimit())
                .isEqualTo(
