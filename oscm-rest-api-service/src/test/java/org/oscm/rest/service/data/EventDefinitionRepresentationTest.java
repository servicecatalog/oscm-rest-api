...
class EventDefinitionRepresentationTest {
    ...
    public void shouldUpdateVOEventDefinition() {
        ...
        assertThat(result)
                .extracting(VOEventDefinition::getEventId)
                .isEqualTo(result.getEventId());
        assertThat(result)
                .extracting(VOEventDefinition::getEventType)
                .isEqualTo(result.getEventType());
        assertThat(result)
                .extracting(BaseVO::getKey)
                .isEqualTo(result.getKey());
        assertThat(result)
                .extracting(BaseVO::getVersion)
                .isEqualTo(result.getVersion());
    }
