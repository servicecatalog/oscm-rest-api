...
class SteppedPriceRepresentationTest {
    ...
    public void shouldUpdateVOSteppedPrice() {
        ...
        assertThat(result)
                .extracting(VOSteppedPrice::getLimit)
                .isEqualTo(representation.getLimit());
        assertThat(result)
                .extracting(VOSteppedPrice::getPrice)
                .isEqualTo(representation.getPrice());
        assertThat(result)
    ...
    public void shouldConvertToSteppedPriceRepresentation() {
        ...
        assertThat(representation)
                ...
                .isEqualTo(voSteppedPrice.getKey());
        assertThat(representation)
