...
public class CategoryRepresentation extends Representation {
        ...
        public static List<VOCategory> update(
                List<CategoryRepresentation> cats) {
        ...
        public static List<CategoryRepresentation> convert(
                List<VOCategory> cats) {
                List<CategoryRepresentation> result = new ArrayList<CategoryRepresentation>();
                if (cats == null) {
                        return result;
                }
                for (VOCategory cat : cats) {
                        CategoryRepresentation cr = new CategoryRepresentation(
                                cat);
                        cr.convert();
                        result.add(cr);
                }
