...
public class AccountRepresentationTest {
  ...
  public void shouldCreateAccountRepresentation() {
    ...
    assertThat(representation.getOrganization()).isEqualTo(organization);
    assertThat(representation.getUser()).isEqualTo(user);
    assertThat(representation.getPassword()).isEqualTo(password);
    assertThat(representation.getServiceKey()).isEqualTo(serviceKey);
    assertThat(representation.getSellerId()).isEqualTo(sellerId);
    assertThat(representation.getLdapProperties()).isEqualTo(ldapProperties);
    assertThat(representation.getOrganizationRoles()).isEqualTo(organizationRoles);
    assertThat(representation.getOrganizationRoles()).isEqualTo(organizationRoles);
  ...
  public void shouldConvertToAccountRepresentation() {
    AccountRepresentation representation = new AccountRepresentation(voLdapProperties);
    representation.setOrganization(organization);
    representation.setUser(user);
    ...
    assertThat(representation.getProps()).isEqualTo(voLdapProperties);
  }
}
