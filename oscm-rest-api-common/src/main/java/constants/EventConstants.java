...
public class EventConstants {
  ...
  public static final String EVENT_MAXIMUM_SUBSCRIPTION_EVENT_BODY =
      "{\n"
  ...
  public static final String EVENT_MAXIMUM_INSTANCE_EVENT_BODY =
      "{\n"
          + "\"occurrenceTime\": 2019060612463227027,\n"
  ...
  public static final String INSTANCE_EVENT_ADDITIONAL_INFO =
      "Make sure that there is a subscription that is bound to technical service instance that you're referencing";
