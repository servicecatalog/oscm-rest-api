...
class SettingRepresentationTest {
    ...
    public void shouldUpdateVOConfigurationSetting() {
        ...
        assertThat(result).extracting(VOConfigurationSetting::getContextId)
                .isEqualTo(representation.getContextId());
        assertThat(result).extracting(VOConfigurationSetting::getInformationId)
                .isEqualTo(representation.getInformationId());
        assertThat(result).extracting(VOConfigurationSetting::getValue)
                .isEqualTo(representation.getValue());
        assertThat(result).extracting(BaseVO::getKey)
                .isEqualTo(representation.getId());
        assertThat(result).extracting(r -> (long) r.getVersion())
                .isEqualTo(representation.getETag());
    }
    ...
    public void shouldConvertSettingsRepresentationToCollection() {
        ...
        assertThat(representationCollection)
                .extracting(r -> representationCollection
                        .getItems().size())
                .isEqualTo(settings.size());
        assertThat(representationCollection)
                .extracting(r -> representationCollection
                        .getItems().iterator().next().getVO().getValue())
